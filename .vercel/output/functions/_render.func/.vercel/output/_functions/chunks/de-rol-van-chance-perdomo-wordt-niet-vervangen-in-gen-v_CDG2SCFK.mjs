const id = "de-rol-van-chance-perdomo-wordt-niet-vervangen-in-gen-v.mdx";
						const collection = "nieuws";
						const slug = "het-eervol-vermalen-van-chance-perdomo-in-gen-v";
						...
						const data = {title:"De rol van Chance Perdomo wordt niet vervangen in Gen V",date:new Date(1714987800000),soort:"TV",thumbnail:"/images/article-images/intro-1714942549.jpg",trailer:"",slug:"het-eervol-vermalen-van-chance-perdomo-in-gen-v",tags:["tv","castin"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/de-rol-van-chance-perdomo-wordt-niet-vervangen-in-gen-v.mdx",
							rawData: undefined,
						};
