const id = "godzilla-kong-en-kung-fu-panda-doen-het-goed-bij-de-box-office.mdx";
						const collection = "nieuws";
						const slug = "het-cinemalandschap-van-gigantische-monsters-tot-geliefde-pandas";
						...
						const data = {title:"Godzilla, Kong en Kung Fu Panda doen het goed bij de box office",date:new Date(1714435200000),soort:"Film",thumbnail:"/images/article-images/intro-1714427752.jpg",trailer:"",slug:"het-cinemalandschap-van-gigantische-monsters-tot-geliefde-pandas",tags:["film"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/godzilla-kong-en-kung-fu-panda-doen-het-goed-bij-de-box-office.mdx",
							rawData: undefined,
						};
