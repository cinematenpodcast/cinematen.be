...
function getHeadings() {
  return [{
    "depth": 2,
    "slug": "julia-garner-als-shalla-bal",
    "text": "Julia Garner als Shalla-Bal"
  }];
}
...
const url = "src/content/nieuws/de-fantastic-four-een-nieuwe-kijk-op-iconische-superhelden.mdx";
const file = "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/de-fantastic-four-een-nieuwe-kijk-op-iconische-superhelden.mdx";
...
Content.moduleId = "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/de-fantastic-four-een-nieuwe-kijk-op-iconische-superhelden.mdx";
