const id = "opstel-nieuwe-wendingen-voor-de-anaconda-franchise.mdx";
						const collection = "nieuws";
						const slug = "er-is-een-chinese-versie-van-de-cult-klassieker-anaconda";
						...
						const data = {title:"Er is een Chinese versie van de cult klassieker Anaconda",date:new Date(1711670400000),soort:"Film",thumbnail:"/images/article-images/anaconda-but-made-in-china-1711469584.jpg",trailer:"3HuZY5Rbjs0",slug:"er-is-een-chinese-versie-van-de-cult-klassieker-anaconda",draft:false,tags:["film","trailer"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/opstel-nieuwe-wendingen-voor-de-anaconda-franchise.mdx",
							rawData: undefined,
						};
