const id = "snow-white-ziet-er-fijn-uit-maar-niet-veel-meer-dan-dat.mdx";
						const collection = "nieuws";
						const slug = "snow-white-ziet-er-fijn-uit-maar-niet-veel-meer-dan-dat";
						...
						const data = {title:"Snow White ziet er fijn uit, maar niet veel meer dan dat…",date:new Date(1733350385163),soort:"film",thumbnail:"/images/article-images/l-intro-1733250602.jpg",trailer:"iV46TJKL8cU",slug:"snow-white-ziet-er-fijn-uit-maar-niet-veel-meer-dan-dat",tags:["film"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/snow-white-ziet-er-fijn-uit-maar-niet-veel-meer-dan-dat.mdx",
							rawData: undefined,
						};
