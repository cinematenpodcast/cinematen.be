const id = "the-crow-remake-met-bill-skarsgård-is-grote-flop-bij-de-box-office.mdx";
						const collection = "nieuws";
						const slug = "het-debacle-van-the-crow-remake-bill-skarsgårds-strijd-in-hollywood";
						...
						const data = {title:"The Crow remake met Bill Skarsgård is grote flop bij de Box Office",date:new Date(1724677970000),soort:"Film",thumbnail:"/images/article-images/intro-1724518567.jpg",trailer:"",slug:"het-debacle-van-the-crow-remake-bill-skarsgårds-strijd-in-hollywood",tags:["film"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/the-crow-remake-met-bill-skarsgård-is-grote-flop-bij-de-box-office.mdx",
							rawData: undefined,
						};
