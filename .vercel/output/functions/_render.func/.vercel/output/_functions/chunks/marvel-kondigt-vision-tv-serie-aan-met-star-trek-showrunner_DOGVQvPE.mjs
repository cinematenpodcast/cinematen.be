const id = "marvel-kondigt-vision-tv-serie-aan-met-star-trek-showrunner.mdx";
						const collection = "nieuws";
						const slug = "marvel-kondigt-vision-tv-serie-aan-met-star-trek-showrunner";
						...
						const data = {title:"Marvel kondigt Vision TV-serie aan met Star Trek showrunner",date:new Date(1716717331000),soort:"TV",thumbnail:"/images/article-images/intro-1716396579.jpg",trailer:"",slug:"marvel-kondigt-vision-tv-serie-aan-met-star-trek-showrunner",tags:["tv","comics"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/marvel-kondigt-vision-tv-serie-aan-met-star-trek-showrunner.mdx",
							rawData: undefined,
						};
