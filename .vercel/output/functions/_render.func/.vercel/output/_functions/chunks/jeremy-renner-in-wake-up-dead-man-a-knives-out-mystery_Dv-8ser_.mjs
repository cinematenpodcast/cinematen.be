const id = "jeremy-renner-in-wake-up-dead-man-a-knives-out-mystery.mdx";
						const collection = "nieuws";
						const slug = "renner-en-craig-verenigd-in-netflixs-knives-out-3";
						...
						const data = {title:"Jeremy Renner in Wake Up Dead Man: A Knives Out Mystery",date:new Date(1717163902000),soort:"Film",thumbnail:"/images/article-images/intro-1717088225.jpg",trailer:"",slug:"renner-en-craig-verenigd-in-netflixs-knives-out-3",tags:["film","casting"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/jeremy-renner-in-wake-up-dead-man-a-knives-out-mystery.mdx",
							rawData: undefined,
						};
