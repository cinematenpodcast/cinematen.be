const id = "krypto-is-de-nieuwe-ster-van-superman.mdx";
						const collection = "nieuws";
						const slug = "krypto-is-de-nieuwe-ster-van-superman";
						...
						const data = {title:"Krypto is de nieuwe ster van Superman",date:new Date(1755427418774),soort:"TV",thumbnail:"/images/article-images/l-intro-1755206433.jpg",trailer:"",slug:"krypto-is-de-nieuwe-ster-van-superman",tags:["TV"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/krypto-is-de-nieuwe-ster-van-superman.mdx",
							rawData: undefined,
						};
