const id = "de-trailer-voor-longlegs-is-hier-de-creepy-horrorfilm-met-nicolas-cage.mdx";
						const collection = "nieuws";
						const slug = "longlegs-nicolas-cage-keert-terug-in-angstaanjagende-horrorfilm";
						...
						const data = {title:"De trailer voor Longlegs is hier, de creepy horrorfilm met Nicolas Cage",date:new Date(1716330353000),soort:"Film",thumbnail:"/images/article-images/maika-monroe-and-nicolas-cage-star-in-longlegs-1716224146.jpg",trailer:"OG7wOTE8NhE",slug:"longlegs-nicolas-cage-keert-terug-in-angstaanjagende-horrorfilm",tags:["film","trailer"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/de-trailer-voor-longlegs-is-hier-de-creepy-horrorfilm-met-nicolas-cage.mdx",
							rawData: undefined,
						};
