const id = "spielberg-en-apatow-maken-samen-cola-vs-pepsi.mdx";
						const collection = "nieuws";
						const slug = "spielberg-en-apatow-maken-samen-cola-vs-pepsi";
						...
						const data = {title:"Spielberg en Apatow maken samen Cola vs Pepsi",date:new Date(1726154618000),soort:"Film",thumbnail:"/images/article-images/intro-1726085244.jpg",trailer:"",slug:"spielberg-en-apatow-maken-samen-cola-vs-pepsi",tags:["film"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/spielberg-en-apatow-maken-samen-cola-vs-pepsi.mdx",
							rawData: undefined,
						};
