const id = "het-langverwachte-vervolg-op-freaky-friday-jamie-lee-curtis-en-lindsay-lohan-opnieuw-samen-op-het-scherm.mdx";
						const collection = "nieuws";
						const slug = "het-langverwachte-vervolg-op-freaky-friday-brengt-jamie-lee-curtis-en-lindsay-lohan-opnieuw-samen-op-het-scherm";
						...
						const data = {title:"Het langverwachte vervolg op Freaky Friday brengt Jamie Lee Curtis en Lindsay Lohan opnieuw samen op het scherm",date:new Date(1711756800000),soort:"Film",thumbnail:"/images/article-images/intro-1711743791.jpg",trailer:"",slug:"het-langverwachte-vervolg-op-freaky-friday-brengt-jamie-lee-curtis-en-lindsay-lohan-opnieuw-samen-op-het-scherm",draft:false,tags:["film","casting"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/het-langverwachte-vervolg-op-freaky-friday-jamie-lee-curtis-en-lindsay-lohan-opnieuw-samen-op-het-scherm.mdx",
							rawData: undefined,
						};
