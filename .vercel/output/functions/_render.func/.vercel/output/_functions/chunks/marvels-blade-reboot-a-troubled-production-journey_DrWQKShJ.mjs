const id = "marvels-blade-reboot-a-troubled-production-journey.mdx";
						const collection = "nieuws";
						const slug = "marvels-blade-reboot-a-troubled-production-journey";
						...
						const data = {title:"Marvel's Blade Reboot heeft (weer) geen regisseur",date:new Date(1718707171000),soort:"Film",thumbnail:"/images/article-images/intro-1718233727.jpg",trailer:"",slug:"marvels-blade-reboot-a-troubled-production-journey",tags:["film","comics"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/marvels-blade-reboot-a-troubled-production-journey.mdx",
							rawData: undefined,
						};
