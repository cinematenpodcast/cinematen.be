...
function getHeadings() {
  return [{
    "depth": 2,
    "slug": "een-moderne-kijk-op-een-actieklassieker",
    "text": "Een moderne kijk op een actieklassieker"
  }, {
    "depth": 2,
    "slug": "regisseur-doug-liman-brengt-stijl-en-actie",
    "text": "Regisseur Doug Liman brengt stijl en actie"
  }, {
    "depth": 2,
    "slug": "terugblik-op-het-origineel-en-een-eerbetoon-aan-swayze",
    "text": "Terugblik op het origineel en een eerbetoon aan Swayze"
  }];
}
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h2, {
      id: "een-moderne-kijk-op-een-actieklassieker",
      children: "Een moderne kijk op een actieklassieker"
...
const url = "src/content/nieuws/jake-gyllenhaal-schittert-in-de-nieuwe-road-house-remake-eerste-blik-op-de-film.mdx";
const file = "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/jake-gyllenhaal-schittert-in-de-nieuwe-road-house-remake-eerste-blik-op-de-film.mdx";
...
Content.moduleId = "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/jake-gyllenhaal-schittert-in-de-nieuwe-road-house-remake-eerste-blik-op-de-film.mdx";
