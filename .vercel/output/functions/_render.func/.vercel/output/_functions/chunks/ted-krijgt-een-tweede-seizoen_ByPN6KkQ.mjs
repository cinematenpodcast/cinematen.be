const id = "ted-krijgt-een-tweede-seizoen.mdx";
						const collection = "nieuws";
						const slug = "ted-seizoen-2-een-kijkje-in-de-anticipatie";
						...
						const data = {title:"Ted krijgt een tweede seizoen",date:new Date(1715365486000),soort:"TV",thumbnail:"/images/article-images/intro-1715275582.jpg",trailer:"",slug:"ted-seizoen-2-een-kijkje-in-de-anticipatie",tags:["tv"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/yorrickschoonheydt/Documents/_Cinematen/cinematen.be-v2/src/content/nieuws/ted-krijgt-een-tweede-seizoen.mdx",
							rawData: undefined,
						};
